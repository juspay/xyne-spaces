...
var selector = (options) => (s) => {
  ...
  return s.getNodes().filter((n) => options.includeHiddenNodes ? true : !n.hidden).every((n) => n[internalsSymbol]?.handleBounds !== void 0);
};
var defaultOptions = {
...
var selector5 = (state) => state.domNode?.querySelector(".react-flow__renderer");

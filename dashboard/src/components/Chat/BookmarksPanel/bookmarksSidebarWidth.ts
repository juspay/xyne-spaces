/**
 * Bookmarks list sidebar width, in pixels.
 *
 ...
 */
export const BOOKMARKS_SIDEBAR_DEFAULT_WIDTH = 280;
export const BOOKMARKS_SIDEBAR_MIN_WIDTH = 220;
export const BOOKMARKS_SIDEBAR_MAX_WIDTH = 560;

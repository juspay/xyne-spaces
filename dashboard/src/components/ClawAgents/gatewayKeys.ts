// Verbatim port of xyne-claw-auth/frontend/src/v3/lib/gatewayKeys.ts.
// Pure helpers for the gateway tool-selection encoding used by ToolboxPicker:
// a gateway source is `gateway:<service>:<backend>` and a per-tool selection
// key is `gateway:<service>:<backend>:<tool>`, each segment URI-encoded.

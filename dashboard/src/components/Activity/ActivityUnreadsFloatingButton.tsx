...
export const ActivityUnreadsFloatingButton = ({
  ...
  <div className='pointer-events-none absolute bottom-[calc(85px+env(safe-area-inset-bottom))] right-4 z-40 min-[700px]:bottom-4'>
    {isActive ? (
      <div className='pointer-events-auto flex items-center overflow-hidden rounded-full bg-primary text-primary-foreground shadow-[0_2px_8px_rgba(0,0,0,0.12)]'>
        <button
          type='button'
          onClick={onActivate}
          aria-pressed='true'
      ...
      <button
        ...
        className='pointer-events-auto rounded-full border border-border bg-card px-4 py-2.5 text-[15px] font-semibold text-muted-foreground shadow-[0_2px_8px_rgba(0,0,0,0.1)] transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 min-[700px]:px-3 min-[700px]:py-2 min-[700px]:text-sm'
        data-testid='activity-unread-toggle'
        data-track-category='ACTIVITY'

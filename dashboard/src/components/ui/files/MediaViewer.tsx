...
export const MediaViewer: React.FC<MediaViewerProps> = ({
  ...
  const renderContent = (): React.ReactElement | null => {
    switch (category) {
      ...
      case 'audio':
        return (
          <div className='bg-white rounded-lg p-12 flex flex-col items-center justify-center gap-6'>
      ...
      case 'csv':
        return csvData && csvData.length > 0 ? (
          <div className='bg-white rounded-lg p-6 max-h-[90vh] overflow-auto'>
    ...
    >
      ...
      >
        {isBrowserSupported ? (
          ...
          <div className='bg-white rounded-lg p-12 text-center flex flex-col items-center justify-center gap-6'>
            <div>
              <p className='text-lg font-semibold text-gray-900 mb-2'>{file.name}</p>
              <p className='text-gray-600'>Viewing in browser not supported</p>
            </div>
            <button
              onClick={onClose}

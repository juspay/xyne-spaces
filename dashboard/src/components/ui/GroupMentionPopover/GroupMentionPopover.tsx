      ...
      <div className='bg-white rounded-lg shadow-lg w-fit border border-muted-foreground/20'>
        ...
        <div className='flex items-start gap-4 p-4'>
          ...
          <div className='flex flex-col min-w-0 flex-1'>
            <div className='font-semibold text-lg text-gray-900 break-words'>{userGroup.name}</div>

            {userGroup.description && (
              <div className='mt-1 text-sm text-gray-700 leading-relaxed break-words line-clamp-2'>
                {userGroup.description}
              </div>
            )}
          </div>
        ...
        <div className='flex justify-end px-4 py-3 border-t border-muted-foreground/20'>
          <button
            ...
            className='inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium bg-gray-100 hover:bg-gray-200 rounded-md transition-colors'
          >

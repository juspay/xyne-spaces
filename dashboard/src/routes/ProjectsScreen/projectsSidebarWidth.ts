/**
 * Project sidebar width, in pixels.
 *
 ...
 */
export const PROJECTS_SIDEBAR_DEFAULT_WIDTH = 280;
export const PROJECTS_SIDEBAR_MIN_WIDTH = 220;
export const PROJECTS_SIDEBAR_MAX_WIDTH = 560;

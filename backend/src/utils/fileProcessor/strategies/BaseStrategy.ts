...
/**
 * Abstract base class for all PDF parsing strategies
 * 
 * Strategies are responsible for extracting text and images from PDF buffers
 * and chunking the content for vector database ingestion.
 */
export abstract class BaseStrategy {
    /**
     * Parse the PDF buffer and extract chunks
     * 

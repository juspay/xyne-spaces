...
- every dispatched Claw run stores one configurable wall-clock deadline; expiry best-effort cancels the session,
  records `CLAW_RUN_TIMED_OUT`, releases admission, and preserves retryable durable state;

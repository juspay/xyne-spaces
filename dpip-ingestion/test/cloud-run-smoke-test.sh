...
[
  {
    "table": "reports",
    "data": [
      ["identifier_type", "reported_date", "party_id", "sub_source", "status", "metrics_type", "metrics_value"],
      ["DPIP_TEST", "2026-07-23", "dpip-test-20260723", "manual", "TEST", "reports_count", 4]
    ]
  },
  {
    "table": "screenings",
    "data": [
      ["screening_date", "party_id", "screening_status", "count"],
      ["2026-07-23", "dpip-test-20260723", "TEST", 1]
    ]
  },
  {

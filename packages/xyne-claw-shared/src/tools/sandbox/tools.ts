 ...
 *   - Committer = Xyne Spaces <noreply@xyne-spaces.local> by default (override via XYNE_GIT_COMMITTER_EMAIL).
 *
...
async function configureGitIdentity(
  ...
  const COMMITTER_EMAIL =
    process.env.XYNE_GIT_COMMITTER_EMAIL ?? "noreply@xyne-spaces.local";

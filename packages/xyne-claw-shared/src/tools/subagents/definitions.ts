...
## Scope
- **github.com only.** Internal company repos live on an internal Bitbucket server — for those, the parent agent should use the \`bitbucket\` subagent, not this one. If you can't find a repo on github.com, say so explicitly — don't fabricate.

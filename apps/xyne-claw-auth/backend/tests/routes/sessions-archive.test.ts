...
vi.mock("../../src/services/storageService.js", () => ({ gcsService: {} }));
vi.mock("../../src/redis.js", () => ({ redisService: {} }));

describe("session archive identifiers", () => {
  it("accepts Claw store keys through the runtime's 128-character limit", async () => {
    const { isSafeConversationId } = await import("../../src/routes/sessions-archive.js");

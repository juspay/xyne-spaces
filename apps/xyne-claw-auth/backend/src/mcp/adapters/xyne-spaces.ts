...
export const xyneSpacesAdapter: StdioMcpAdapter = {
  ...
  writeTools: ["spaces-create-ticket", "spaces-update-ticket", "spaces-schedule-call", "spaces-create-canvas", "spaces-edit-canvas", "user-send-message", "spaces-upload-to-kb", "spaces-create-kb-collection", "spaces-create-kb-folder"],
  credentialFields: [

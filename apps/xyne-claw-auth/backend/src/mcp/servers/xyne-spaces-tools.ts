...
const spacesSdlcMutateArtifact: ToolDef = {
  ...
  description:
    ...
    "artifact of any type, pass its folderId (from that tool) plus trackId (the SDLC track it belongs to; Repo Knowledge takes none). To update " +
  ...
  inputSchema: {
    ...
    properties: {
      ...
      trackId: { type: "string", minLength: 1, description: "The SDLC track this artifact belongs to. Required for every artifact type except Repo Knowledge, which describes the hub itself. Get it from spaces-sdlc-list-artifacts or the user's chosen track." },

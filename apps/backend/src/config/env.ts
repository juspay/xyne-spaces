...
const envSchema = Joi.object({
  ...
  GCS_PROJECT_ID: Joi.string().default('xyne-spaces'),
  GCS_BUCKET_NAME: Joi.string().default('xyne-spaces-chat-documents'),
  GCS_BUNDLE_BUCKET_NAME: Joi.string().default('xyne-frontend-bundles'),
  GCS_CANVAS_BUCKET_NAME: Joi.string().default('xyne-spaces-canvas-documents'),
  GCS_DOCS_BUCKET_NAME: Joi.string().default('xyne-spaces-canvas-documents'),
  GCS_MAX_FILE_SIZE_MB: Joi.number().default(1024),
  FAKE_GCS_HOST: Joi.string().default('localhost:4443'),
  TRANSCRIPTION_BUCKET_NAME: Joi.string().default('transcription-dev-v2'),
  GCS_WORKFLOW_STEPS_BUCKET_NAME: Joi.string().default('xyne-workflow-steps'),
  GCS_SESSION_RECORDING_BUCKET_NAME: Joi.string().default('xyne-session-recordings'),
  GCS_WORKFLOW_VR_BUCKET_NAME: Joi.string().default('xyne-spaces-visual-regression'),

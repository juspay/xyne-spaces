...
import { applyStageRemapTx } from '@/bypassAcl/transactions/boardConfigCopyService';
...
export class BoardConfigCopyService {
  ...
  async applyStageRemap(
    ...
    return applyStageRemapTx(ticketId, targetBoardId, oldStageName, target, actorUserId, oldStageId);
  }

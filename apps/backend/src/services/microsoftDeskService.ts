...
import { createChannelAndSourceTx } from '@/bypassAcl/transactions/microsoftDeskService';
...
export class MicrosoftDeskService {
  ...
  async createChannelAndSource(
    ...
    const channelId = await createChannelAndSourceTx(channelData, sourceName, credentials, encryptedCredentials, this, webhookUrl, clientState);

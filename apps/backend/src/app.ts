...
export class App {
  ...
  private initializeRoutes(): void {
    ...
    this.app.use('/api/admin/ai-provisioning-backfill', workspaceScopedRoute, aiProvisioningBackfillRoutes);
    this.app.use('/migrate/api/admin/ai-provisioning-backfill', workspaceScopedRoute, aiProvisioningBackfillRoutes);

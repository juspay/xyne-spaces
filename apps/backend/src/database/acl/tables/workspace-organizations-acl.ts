 ...
 */
export class WorkspaceOrganizationsACL extends BaseQueryACL<
  Prisma.WorkspaceOrganizationWhereInput,
  Prisma.WorkspaceOrganizationUncheckedCreateInput
> {
  ...
  async getMutateWhere(): Promise<Prisma.WorkspaceOrganizationWhereInput> {
  ...
  async canCreate(_data: Prisma.WorkspaceOrganizationUncheckedCreateInput): Promise<boolean> {
    return false
  }
}

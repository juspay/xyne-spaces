/*
  ...
  - Made the column `workspaceId` on table `docling_async_files` required. This step will fail if there are existing NULL values in that column.
  - Made the column `workspaceId` on table `docling_async_parts` required. This step will fail if there are existing NULL values in that column.
  ...
  - Made the column `workspaceId` on table `vespa_insertion_logs` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE "non_zero"."docling_async_files" ALTER COLUMN "workspaceId" SET NOT NULL;

-- AlterTable
ALTER TABLE "non_zero"."docling_async_parts" ALTER COLUMN "workspaceId" SET NOT NULL;
...
-- AlterTable
ALTER TABLE "workflow"."vespa_insertion_logs" ALTER COLUMN "workspaceId" SET NOT NULL;

-- Additive channel -> board mapping infrastructure. Legacy projectId columns
...
-- A channel can have at most one default board. PostgreSQL partial indexes are
-- used because Prisma cannot express this invariant in schema.prisma.

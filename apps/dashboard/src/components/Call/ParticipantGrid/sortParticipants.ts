 ...
 * back to ourselves when nobody else has joined. The fallback exists for
 * presentation mode — a telepresence wall alone in a room should show itself
 * rather than an empty "waiting for remote participant" screen, which is its

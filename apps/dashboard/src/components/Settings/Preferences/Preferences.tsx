  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='space-y-3'>
        ...
        <div className='flex items-center justify-between gap-4 p-3 rounded-lg border border-border bg-muted/30'>
          <div>
            <p className='text-sm font-medium text-foreground'>Copy ticket id button</p>
            <p className='text-xs text-muted-foreground mt-0.5'>
              Show a copy button for the internal ticket id in ticket details.
            </p>
          </div>
          <Switch
            id='show-ticket-id-copy-button'
            checked={state.debugSettings.showTicketIdCopyButton}
            onCheckedChange={state.toggleTicketIdCopyButton}
          />
        </div>

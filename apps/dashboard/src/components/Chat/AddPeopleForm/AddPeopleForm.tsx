...
import { User, ChannelScopeType, type HistoryScope, type HistoryScopeMode } from '@xyne/shared';
...
export const AddPeopleForm: React.FC<AddPeopleFormProps> = ({
  ...
  useEffect(() => {
    onContextChange?.({ step, isDirectConversation, joinsExistingConversation });

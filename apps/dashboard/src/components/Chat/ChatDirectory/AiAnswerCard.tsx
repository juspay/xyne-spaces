 ...
 */
const SETTLE_MS = 600;
const CARD_CLASS = 'mb-3 px-2 py-2';
  ...
  return (
    <section className={CARD_CLASS} aria-live='polite'>
      ...
      {answer.content && current ? (
        ...
        <div className='max-h-60 overflow-y-auto text-sm leading-6 text-foreground [&_p]:my-1.5 [&_p:first-child]:mt-0 [&_p:last-child]:mb-0'>

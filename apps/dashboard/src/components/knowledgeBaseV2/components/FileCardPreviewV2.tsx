...
interface FileCardPreviewV2Props {
  format: string;
  size?: 'sm' | 'md';
}
...
const DefaultLines = (): React.ReactElement => (
  <div className='space-y-1.5'>
    <div className='flex gap-2'>
      <div className='h-0.5 w-1/2 rounded-full bg-gray-900/20' />
    </div>
    <div className='flex gap-1'>
      <div className='h-0.5 w-1/3 rounded-full bg-gray-900/10' />
      <div className='h-0.5 w-1/3 rounded-full bg-gray-900/10' />
    </div>
    <div className='flex gap-1'>
      <div className='h-0.5 w-1/2 rounded-full bg-gray-900/10' />
      <div className='h-0.5 w-1/3 rounded-full bg-gray-900/10' />
    </div>
    <div className='flex gap-1'>
      <div className='h-0.5 w-1/3 rounded-full bg-gray-900/10' />
...
const MarkdownInterior = (): React.ReactElement => (
  <div className='space-y-1.5'>
    <div className='flex items-center gap-1'>
      <div className='text-[10px] font-bold text-gray-900/30'>#</div>
      <div className='h-0.5 w-6 rounded-full bg-gray-900/20' />
    </div>
    <div className='space-y-1'>
      <div className='h-0.5 w-1/3 rounded-full bg-gray-900/10' />
      <div className='h-0.5 w-7 rounded-full bg-gray-900/10' />
    </div>
    <div className='space-y-1'>
      <div className='h-0.5 w-8 rounded-full bg-gray-900/10' />
      <div className='h-0.5 w-4 rounded-full bg-gray-900/10' />
      <div className='h-0.5 w-1/3 rounded-full bg-gray-900/10' />
    </div>
  </div>
);

const SpreadsheetInterior = (): React.ReactElement => (
  <div className='space-y-0.5'>
    <div className='grid grid-cols-3 gap-0.5'>
      <div className='h-2 bg-gray-900/20' />
      <div className='h-2 bg-gray-900/20' />
      <div className='h-2 bg-gray-900/20' />
    </div>
    <div className='grid grid-cols-3 gap-0.5'>
      <div className='h-2 bg-gray-900/5' />
      <div className='h-2 bg-gray-900/5' />
      <div className='h-2 bg-gray-900/5' />
      <div className='h-2 bg-gray-900/5' />
      <div className='h-2 bg-gray-900/5' />
...
const CsvInterior = (): React.ReactElement => (
  <>
    <div className='mb-2 grid grid-cols-3 gap-0.5'>
      <div className='h-1.5 rounded-full bg-gray-900/20' />
      <div className='h-1.5 rounded-full bg-gray-900/20' />
      <div className='h-1.5 rounded-full bg-gray-900/20' />
    </div>
    <div className='space-y-1.5'>
      <div className='grid grid-cols-3 gap-0.5'>
        <div className='h-1 rounded-full bg-gray-900/5' />
        <div className='h-1 rounded-full bg-gray-900/5' />
        <div className='h-1 rounded-full bg-gray-900/5' />
      </div>
      <div className='grid grid-cols-3 gap-0.5'>
...
const ArchiveInterior = (): React.ReactElement => (
  <div className='relative flex h-full flex-col items-center justify-center'>
    <div className='space-y-0'>
      {Array.from({ length: 9 }).map((_, i) => (
        <div key={i} className='flex overflow-hidden rounded-full'>
          <div className={cn('size-1.5', i % 2 === 0 ? 'bg-gray-900/20' : 'bg-gray-900/5')} />
          <div className={cn('size-1.5', i % 2 === 0 ? 'bg-gray-900/5' : 'bg-gray-900/20')} />
        </div>
      ))}
    </div>
  </div>
...
const SlideInterior = (): React.ReactElement => (
  <>
    <div className='mb-1.5 space-y-1 rounded border border-gray-200 bg-gray-900/5 p-1'>
      <div className='flex justify-center gap-1'>
        <div className='size-3 rounded-sm bg-orange-400/40' />
      </div>
      <div className='mx-auto h-[3px] w-8 rounded-full bg-gray-900/15' />
    </div>
    <div className='mb-1 flex justify-center gap-1'>
      <div className='h-[3px] w-8 rounded-full bg-gray-900/15' />
      <div className='h-[3px] w-4 rounded-full bg-gray-900/15' />
    </div>
    <div className='space-y-1'>
      <div className='h-[3px] w-4 rounded-full bg-gray-900/15' />
      <div className='h-[3px] w-5 rounded-full bg-gray-900/15' />
    </div>
  </>
);

const ImageInterior = (): React.ReactElement => (
  <div className='mb-1.5 space-y-1 rounded border border-gray-200 bg-gray-900/5 p-1'>
    <div className='flex justify-center gap-1'>
      <div className='size-3 rounded-sm bg-yellow-400/40' />
    </div>
    <div className='mx-auto mt-1 h-[3px] w-4 rounded-full bg-gray-900/15' />
    <div className='mx-auto h-[3px] w-8 rounded-full bg-gray-900/15' />
  </div>
);

const VideoInterior = (): React.ReactElement => (
  <div className='mb-1.5 space-y-1 rounded border border-gray-200 bg-gray-900/5 p-1'>
    <div className='flex justify-center gap-1'>
...
const AudioInterior = (): React.ReactElement => (
...
const CodeInterior = (): React.ReactElement => (
  <div className='space-y-1'>
    <div className='flex items-center gap-0.5'>
      <div className='font-mono text-[5px] text-gray-900/30'>&lt;</div>
...
const CssInterior = (): React.ReactElement => (
  <div className='space-y-1'>
    <div className='font-mono text-[6px] text-gray-900/40'>{'{'}</div>
...
const JsonInterior = (): React.ReactElement => (
  <div className='space-y-1'>
    <div className='font-mono text-[6px] text-gray-900/40'>{'{'}</div>
    <div className='flex items-center gap-1 pl-1.5'>
      <div className='h-[3px] w-3 rounded-full bg-gray-900/20' />
      <div className='h-[3px] w-4 rounded-full bg-gray-900/20' />
    </div>
    <div className='flex items-center gap-1 pl-1.5'>
      <div className='h-[3px] w-4 rounded-full bg-gray-900/10' />
      <div className='h-[3px] w-2 rounded-full bg-gray-900/10' />
    </div>
    <div className='flex items-center gap-1 pl-1.5'>
      <div className='h-[3px] w-3 rounded-full bg-gray-900/10' />
      <div className='h-[3px] w-4 rounded-full bg-gray-900/10' />
    </div>
    <div className='flex items-center gap-1 pl-1.5'>
      <div className='h-[3px] w-3 rounded-full bg-gray-900/10' />
...
export const FileCardPreviewV2: React.FC<FileCardPreviewV2Props> = ({ format, size = 'md' }) => {
  ...
  return (
    <div aria-hidden className='relative size-fit'>
      ...
      <div
        className={cn(
          'relative z-[1] overflow-hidden rounded-md bg-white ring-1 ring-gray-200',
          dims,
        )}
      >
        {interiorFor(fmt)}

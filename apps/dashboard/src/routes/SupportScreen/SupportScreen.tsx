...
const SupportScreen = (): ReactElement => {
  ...
  const submenuPointerDownInsideRef = useRef(false);
                        ...
                        <>
                          ...
                          <Popover.Root open={moreFiltersOpen} onOpenChange={setMoreFiltersOpen}>
                            ...
                            <Popover.Content
                              ...
                              onInteractOutside={e => {
                                if (submenuPointerDownInsideRef.current) {
                                  e.preventDefault();
                                  return;
                                }
                            ...
                            {activeSubmenu && menuItemRefs.current[activeSubmenu] && (
                              <div
                                ...
                                onPointerDownCapture={e => {
                                  ...
                                  submenuPointerDownInsideRef.current = true;
                                  requestAnimationFrame(() => {
                                    submenuPointerDownInsideRef.current = false;
                                  });
                                }}

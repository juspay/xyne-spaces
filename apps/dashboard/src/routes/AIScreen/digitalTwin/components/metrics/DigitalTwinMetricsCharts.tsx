            ...
            <ResponsiveContainer width='100%' height={CHART_HEIGHT}>
              ...
              >
                ...
                <Legend
                  ...
                  align='left'
                />
                <Bar dataKey='Approved' stackId='s' fill='#22c55e' cursor='pointer' />
                <Bar dataKey='Rejected' stackId='s' fill='#ef4444' cursor='pointer' />
                <Bar
                  dataKey='Pending'
                  stackId='s'
                  fill='#f59e0b'
          ...
          <ResponsiveContainer width='100%' height={CHART_HEIGHT}>
            <BarChart data={bySource} margin={{ top: 16, right: 16, bottom: 0, left: 0 }}>
              ...
              <Legend
                ...
                align='left'
              />
              <Bar dataKey='Approved' fill='#22c55e' radius={[4, 4, 0, 0]} cursor='pointer' />
              <Bar dataKey='Rejected' fill='#ef4444' radius={[4, 4, 0, 0]} cursor='pointer' />
            </BarChart>
          </ResponsiveContainer>
        )}
      </MetricsCard>

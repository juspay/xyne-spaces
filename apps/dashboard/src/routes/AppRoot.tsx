...
export const router = createBrowserRouter(
  [
    ...
    // The SDLC bundle is served under a base path ('/sdlc-app'), so every route
    // above is matched relative to it. APP_BASE_PATH is '/' for the main bundle,
    // which react-router treats as no basename at all.
  ],

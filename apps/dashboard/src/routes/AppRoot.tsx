              ...
              <AIOnboardingProvider>
                ...
                <EditProvider>
                  ...
                  <SdlcFrameProvider>
                    ...
                    {isInPanelWebview ? (
                      ...
                      <div className='flex h-screen flex-col'>
                        <ResizableGroup
                          ...
                          autoSaveId='app-root-sdlc-debugger'
                        >
                          <Panel id='app-root-sdlc-content' defaultSize='65%' minSize='45%'>
                            <div className='flex h-full min-w-0 overflow-hidden'>
                              <AppSidebar />
                              <main className='min-w-0 flex-1 overflow-auto no-scrollbar'>
                                <EditWarningModal />
                                <Outlet />
                              </main>
                            </div>
                    ...
                    ) : // Not on SDLC routes: the framed SDLC lane renders its own Ask AI
                    // panel inside the iframe, so the host stays out of the way there and
                    // shows its panel again once you leave the SDLC view.
                    isXyneAIDrawerOpen && !isMobile && !isOnAIPage && !isSdlcRoute ? (
...
export const router = createBrowserRouter(
  [
    ...
    // '/' for the main bundle, which react-router treats as no basename.
  ],

...
const ClawDigitalTwinScreen = (): ReactElement => {
  ...
  const navClassName = ({ isActive }: { isActive: boolean }): string =>
    cn(
      'dt-transition flex h-8 shrink-0 items-center justify-center rounded-[10px] px-3 py-1',
  ...
  return (
    <div className='digital-twin-ledger min-h-full w-full bg-background text-foreground'>
      ...
      <div className='mx-auto flex w-full max-w-[800px] flex-col gap-5 px-4 pb-16 pt-5 sm:px-0'>
        <header className='flex flex-col gap-5'>
          <div className='flex w-full items-center gap-5 pl-3'>
        ...
        <main id='digital-twin-content' className='min-w-0' tabIndex={-1}>
          {isLoading && !status ? (

  ...
  const controls = (
    <div className='flex h-9 w-full items-center gap-4 rounded-[10px] bg-foreground/[0.04] pl-2.5 pr-1'>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger
          className={cn(
            'relative flex size-7 items-center justify-center rounded-[10px] border-0 p-0 text-foreground/40 shadow-none outline-none hover:bg-foreground/[0.04] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 data-[state=open]:bg-foreground/[0.06]',

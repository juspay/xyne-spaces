...
| ------------ | ------------- | ----------------------------------------------------- | ------------- | ----------------------------------------- |
| Memories     | `/`           | Primary **Memories** tab                              | `/`           | Same route; page substantially redesigned |
...
| None         | None          | Primary **Persona** tab                               | `/persona`    | New dashboard route                       |
...
| --------------------------- | -------------------------------------- | ----------------------------------------------- |
| Persona file editor         | `/persona`                             | Exposes existing memory-file APIs               |
| Prompt-loading controls     | Persona                                | Exposes the three-file prompt limit             |
| Persona rebuild             | Persona -> Rebuild                     | Exposes the synthesis API                       |
...
> knowledge, while Disable moved into Settings. Persona and Activity are new
> self-service screens exposing backend capabilities that previously had no
> corresponding Spaces UI.

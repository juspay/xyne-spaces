# Create Ticket from Message E2E Flow
> Convert sent chat messages into tickets via hover-action and thread panel, with and without attachments.

## Create ticket from sent message via hover action
...
## Create ticket from message via hover action with attachment
* Setting up ticket test with user "user-2" in channel "channel-1" for admin "admin-1"

...
async function runTests(): Promise<void> {
  ...
  // Define Log Paths
  const LOG_DIR = path.join(projectRoot, 'tools/xyne-automation/report');
  ...
  const steps: StepDef[] = [
    ...
    },
    {
      ...
      command: 'rm',
      args: ['-rf', 'tools/xyne-automation/report/*'],
    },
    {
  ...
  const cleanupSteps: StepDef[] = [
    {
      ...
      command: 'docker',
      args: ['cp', `${composeProjectName}-automation:/app/report/.`, 'tools/xyne-automation/report/'],

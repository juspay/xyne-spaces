...
Feature: My Tickets - Filter and View Options
  ...
  Scenario: User can apply and clear filters, switch views, and change group-by options
    ...
    And I should see the element "[data-testid='filter-menu-priority']"
    And I click on "[data-testid='filter-menu-priority']"
    And I should see the element "[data-testid='priority-filter-low']"
    ...
    And I press "Escape"
    And I should see the element "[data-testid='clear-filters-btn']"

...
Feature: My Tickets - Filter and View Options
  ...
  Scenario: User can apply and clear filters, switch views, and change group-by options
    ...
    And I click on "[data-testid='filter-menu-userGroups']"
    And I click the button with text "ADMIN"
    And I click the button with text "DEVELOPER"
    And I click the button with text "VIEWER"

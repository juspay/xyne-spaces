...
export const Event = {
  ...
  LOTUS_SPLASH_SHOWN: "lotus_splash_shown",
  LOTUS_SPLASH_HIDDEN: "lotus_splash_hidden",
  LOTUS_ENROLLMENT_CHECK: "lotus_enrollment_check",
  LOTUS_AUTH_CHECK: "lotus_auth_check",
  LOTUS_NAVIGATION_READY: "lotus_navigation_ready",
  LOTUS_SCREEN_ENTER: "lotus_screen_enter",
  LOTUS_SCREEN_EXIT: "lotus_screen_exit",
  LOTUS_CALL_INCOMING: "lotus_call_incoming",
  LOTUS_CALL_ACCEPTED: "lotus_call_accepted",
  LOTUS_CALL_DECLINED: "lotus_call_declined",
  LOTUS_CALL_ENDED: "lotus_call_ended",
  LOTUS_NOTIFICATION_RECEIVED: "lotus_notification_received",
  LOTUS_NOTIFICATION_TAPPED: "lotus_notification_tapped",
  LOTUS_OTA_UPDATE_DETECTED: "lotus_ota_update_detected",
  LOTUS_CRASH_DETECTED: "lotus_crash_detected",
  LOTUS_BATTERY_LOW: "lotus_battery_low",
  LOTUS_MEMORY_WARNING: "lotus_memory_warning",
  LOTUS_API_SUCCESS: "lotus_api_success",
  ...
  LOTUS_ZERO_SYNC_ERROR: "lotus_zero_sync_error",
  LOTUS_JS_BUNDLE_LOADED: "lotus_js_bundle_loaded",
  LOTUS_COLD_START_CALL_DETECTED: "lotus_cold_start_call_detected",
  LOTUS_DISPLAY_MODE_CHANGED: "lotus_display_mode_changed",
  ...
  // Crash tracking events
  LOTUS_JS_CRASH: "lotus_js_crash",
  LOTUS_NATIVE_CRASH_ANDROID: "lotus_native_crash_android",
  LOTUS_NATIVE_CRASH_IOS: "lotus_native_crash_ios",

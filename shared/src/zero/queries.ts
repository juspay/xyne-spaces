...
export const queries = defineQueries({
  ...
  // All conversation mappings carrying a given label (for the per-label panel view).
  // Pulls the conversation and its ticket so the panel can navigate to the thread.
